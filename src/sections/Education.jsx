...
import { Code2, PenTool, Bug } from "lucide-react";
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-linear-to-b from-purple-500 via-purple-400/40 to-transparent"></div>
          ...
          <div className="relative flex items-center justify-center perspective-[1000px]">
            ...
            <button
              onClick={prev}
              className="absolute left-5 z-20 p-3 rounded-xl 
